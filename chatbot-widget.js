...
function startConversation() {
    fetch('https://chatbot-for-westbrook-montessori-academy.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //  sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-westbrook-montessori-academy.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwZNEpqL98zHU-WMrp0zBqwXlDAlxCT_Qhr6wS5RjRuYrz3W6KWTVBZAUD_331K5Pq2Pg/exec';
